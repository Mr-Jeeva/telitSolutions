...
class GetItTouchWeb extends StatefulWidget {
  const GetItTouchWeb(AutoScrollController aScrollController, {super.key});

  @override
  State<GetItTouchWeb> createState() => _GetItTouchWebState();
}

class _GetItTouchWebState extends State<GetItTouchWeb> {
  @override

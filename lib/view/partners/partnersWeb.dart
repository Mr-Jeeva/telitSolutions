...
class PartnersWeb extends StatefulWidget {
  const PartnersWeb(AutoScrollController aScrollController, {super.key});

  @override
  State<PartnersWeb> createState() => _PartnersWebState();
}

class _PartnersWebState extends State<PartnersWeb> {
              ...
              Row(
                children: [
                  InkWell(
                      ...
                      child: Icon(Icons.arrow_back_ios_rounded, size: SizeConfig.getScreenWidth(context) * 0.03,color: Colors.black54,)),
                  Expanded(
                    child: SizedBox(

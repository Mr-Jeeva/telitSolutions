...
class PartnersMobile extends StatefulWidget {
  const PartnersMobile(AutoScrollController aScrollController, {super.key});
...
class _PartnersMobileState extends State<PartnersMobile> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(left: SizeConfig.getScreenWidth(context) * 0.05,
          right: SizeConfig.getScreenWidth(context) * 0.05),
      child: Column(
              ...
              children: [
                ...
                Text("We partner with the",
                    style: GoogleFonts.ubuntu(
                        height: 1, fontSize: SizeConfig.getScreenWidth(context) * 0.05, fontWeight: FontWeight.bold, color: AppColors.primaryColor)),
                Text("best clients",
                    style: GoogleFonts.ubuntu(
                        height: 1, fontSize: SizeConfig.getScreenWidth(context) * 0.05, fontWeight: FontWeight.bold, color: AppColors.secondaryColor)),
              ],
            ),
          ),
          Expanded(
                ...
                Center(
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: SizedBox(
                          height: SizeConfig.getScreenWidth(context) * 0.25,
